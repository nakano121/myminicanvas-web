...
Here's our answers, on the record: your child's drawings and voice recordings live on your device, not on our servers. AI requests are processed and not stored, and never used to train models. No account is required, there is no feed, no public gallery, and nothing is shared unless you export it yourself. We're a paid app — money for magic — precisely so your family's data never has to be the product. This isn't a feature we added; it's [the reason we built it this way](/blog/ai-helps-parents-tell-stories/).
